...
* CHECKPOINT SYSTEM: It works on both characters; It essentially "drags" a character to the right spot. Had to create a "playerspawn" scene as well so it has another place to respawn when it's not a checkpoint.
